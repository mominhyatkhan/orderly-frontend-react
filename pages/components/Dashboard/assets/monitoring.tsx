...
const Monitoring = () => {
  ...
  return (
    ...
    isMonitor?
    <PortfolioMonitoring/>
    :<div className="flex flex-col ml-40 mr-40 mt-28">
    <h1 className=" w-full text-3xl mb-8">Monitoring</h1>
    <div className="flex bg-white h-full item-center">
      <div className="item-center ml-96 mt-40 mb-80 ">
        <svg
        ...
        <h1 className="max-w-xs text-gray-300">
          Start monitoring network, token or full portfolio. Note we anonymize
          all data.
        </h1>
        <div className="mt-4 ml-14 flex max-w-xs ">
          <button onClick={()=>setMonitor(!isMonitor)} className="self-center bg-[#6b8068] w-36 h-10 hover:bg-emerald-700 text-white rounded">
            Add Monitoring
          </button>
        </div>
      </div>
